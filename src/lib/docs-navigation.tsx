...
const navigationCopy = {
  'zh-CN': {
    ...
    pages: {
      ...
      rustSdk: 'Rust SDK 接入',
      thinSdk: 'Thin SDK',
      thinSdkGo: 'Go Thin SDK',
      thinSdkJava: 'Java Thin SDK',
      thinSdkPython: 'Python Thin SDK',
      thinSdkNodejs: 'Node.js Thin SDK',
      thinSdkCpp: 'C++ Thin SDK',
      thinSdkCsharp: 'C# Thin SDK',
    ...
    children: [
      ...
      folder(copy.folders.guides, [
        ...
        folder(
          copy.pages.thinSdk,
          [
            alias(copy.pages.thinSdkGo, ['components', 'thin-sdk', 'go']),
            alias(copy.pages.thinSdkJava, ['components', 'thin-sdk', 'java']),
            alias(copy.pages.thinSdkPython, ['components', 'thin-sdk', 'python']),
            alias(copy.pages.thinSdkNodejs, ['components', 'thin-sdk', 'nodejs']),
            alias(copy.pages.thinSdkCpp, ['components', 'thin-sdk', 'cpp']),
            alias(copy.pages.thinSdkCsharp, ['components', 'thin-sdk', 'csharp']),
          ],
