...
const navigationCopy = {
  'zh-CN': {
    ...
    pages: {
      ...
      consoleAiRegistry: 'AI Registry 与 Pole Agent',
      consoleSystem: '系统配置',
      consoleMetrics: '监控指标',
      rustSdk: 'Rust SDK 接入',
  ...
  en: {
    ...
    pages: {
      ...
      consoleAiRegistry: 'AI Registry and Pole Agent',
    ...
    children: [
      ...
      folder(copy.folders.guides, [
        ...
        folder(copy.pages.console, [
          ...
          alias(copy.pages.consoleGovernance, ['guides', 'console', 'governance']),
          alias(copy.pages.consoleAuthorization, ['guides', 'console', 'authorization']),
          alias(copy.pages.consoleAiRegistry, ['guides', 'console', 'ai-registry']),
