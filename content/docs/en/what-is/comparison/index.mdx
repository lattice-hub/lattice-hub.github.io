...
| --- | --- | --- |
| [Registry and configuration comparison](/en/docs/what-is/comparison/registry-config) | Pole, Nacos, Apollo, PolarisMesh | Discovery, health checks, Kubernetes synchronization, dynamic configuration, versions and rollback, gray configuration, authorization, and migration entry points |
