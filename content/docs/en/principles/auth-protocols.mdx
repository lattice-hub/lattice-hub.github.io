...
![auth check path](/diagrams/auth-check-path.svg)
...
![policy resource validation](/diagrams/policy-resource-validation.svg)
...
![release auth mapping](/diagrams/release-auth-mapping.svg)
