...
Specification (`pole-io/specification`) is the cross-component contract layer. It defines messages and gRPC interfaces; it does not run the control plane. `pole-control-plane` is the primary server implementation. SDKs, Pole Sidecar, Controllers, and protocol adapters consume the same wire contract.
